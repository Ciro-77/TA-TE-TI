def nuestra_func():
    try:
        print( 'Bienvenid@ a nuestro proyecto de: TA TE TI' )
        print ( 'Somos Cintia Solier, Luciano Bogarin y Ciro Farias' )
        ...
        print('No es un numero comprendido entre uno y nueve, volve a intentar =/')
nuestra_func()
